...
INSERT INTO `config_item` (`id`, `p_id`, `name`, `code`, `data`, `sort`) VALUES (1, 0, '云平台类型', 'cloudPlatformType', NULL, NULL);
INSERT INTO `config_item` (`id`, `p_id`, `name`, `code`, `data`, `sort`) VALUES (101, 1, '运营云', 'operational', NULL, 1);
INSERT INTO `config_item` (`id`, `p_id`, `name`, `code`, `data`, `sort`) VALUES (102, 1, '交付云', 'delivery', NULL, 2);
INSERT INTO `config_item` (`id`, `p_id`, `name`, `code`, `data`, `sort`) VALUES (2, 0, '区域类型', 'regionType', NULL, NULL);
INSERT INTO `config_item` (`id`, `p_id`, `name`, `code`, `data`, `sort`) VALUES (201, 2, '合设区域', 'merge', NULL, 1);
INSERT INTO `config_item` (`id`, `p_id`, `name`, `code`, `data`, `sort`) VALUES (202, 2, '业务区域', 'business', NULL, 2);
INSERT INTO `config_item` (`id`, `p_id`, `name`, `code`, `data`, `sort`) VALUES (203, 2, '管理区域', 'manage', NULL, 3);
INSERT INTO `config_item` (`id`, `p_id`, `name`, `code`, `data`, `sort`) VALUES (3, 0, '项目类型', 'projectType', NULL, NULL);
INSERT INTO `config_item` (`id`, `p_id`, `name`, `code`, `data`, `sort`) VALUES (301, 3, '新建', 'create', NULL, 1);
INSERT INTO `config_item` (`id`, `p_id`, `name`, `code`, `data`, `sort`) VALUES (302, 3, '扩容', 'expansion', NULL, 2);
INSERT INTO `config_item` (`id`, `p_id`, `name`, `code`, `data`, `sort`) VALUES (303, 3, '升级', 'upgradation', NULL, 3);
INSERT INTO `config_item` (`id`, `p_id`, `name`, `code`, `data`, `sort`) VALUES (4, 0, '项目阶段', 'projectStage', NULL, NULL);
INSERT INTO `config_item` (`id`, `p_id`, `name`, `code`, `data`, `sort`) VALUES (401, 4, '规划阶段', 'planning', NULL, 1);
INSERT INTO `config_item` (`id`, `p_id`, `name`, `code`, `data`, `sort`) VALUES (402, 4, '交付阶段', 'delivery', NULL, 2);
INSERT INTO `config_item` (`id`, `p_id`, `name`, `code`, `data`, `sort`) VALUES (403, 4, '已交付', 'delivered', NULL, 3);
INSERT INTO `config_item` (`id`, `p_id`, `name`, `code`, `data`, `sort`) VALUES (5, 0, '方案类型', 'planType', NULL, NULL);
INSERT INTO `config_item` (`id`, `p_id`, `name`, `code`, `data`, `sort`) VALUES (501, 5, '普通方案', 'general', NULL, 1);
INSERT INTO `config_item` (`id`, `p_id`, `name`, `code`, `data`, `sort`) VALUES (502, 5, '备选方案', 'alternate', NULL, 2);
INSERT INTO `config_item` (`id`, `p_id`, `name`, `code`, `data`, `sort`) VALUES (503, 5, '交付方案', 'delivery', NULL, 3);
INSERT INTO `config_item` (`id`, `p_id`, `name`, `code`, `data`, `sort`) VALUES (6, 0, '方案阶段', 'planStage', NULL, NULL);
INSERT INTO `config_item` (`id`, `p_id`, `name`, `code`, `data`, `sort`) VALUES (601, 6, '待规划', 'plan', NULL, 1);
INSERT INTO `config_item` (`id`, `p_id`, `name`, `code`, `data`, `sort`) VALUES (602, 6, '规划中', 'planning', NULL, 2);
INSERT INTO `config_item` (`id`, `p_id`, `name`, `code`, `data`, `sort`) VALUES (603, 6, '规划完成', 'planned', NULL, 3);
INSERT INTO `config_item` (`id`, `p_id`, `name`, `code`, `data`, `sort`) VALUES (604, 6, '交付中', 'delivering', NULL, 4);
INSERT INTO `config_item` (`id`, `p_id`, `name`, `code`, `data`, `sort`) VALUES (605, 6, '交付完成', 'delivered', NULL, 5);
INSERT INTO `config_item` (`id`, `p_id`, `name`, `code`, `data`, `sort`) VALUES (7, 0, '集群类型', 'cellType', NULL, NULL);
INSERT INTO `config_item` (`id`, `p_id`, `name`, `code`, `data`, `sort`) VALUES (701, 7, '控制集群', 'control', NULL, 1);
INSERT INTO `config_item` (`id`, `p_id`, `name`, `code`, `data`, `sort`) VALUES (702, 7, '业务集群', 'business', NULL, 2);
...
(
    ...
    `cpu_num`               int(11) DEFAULT NULL COMMENT 'CPU数',
    `cpu_core_num`          int(11) DEFAULT NULL COMMENT 'CPU核数',
    `cpu`                   int(11) DEFAULT NULL COMMENT 'vCPU数',
...
(
    ...
    `actual_consume`        varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '实际消耗',
