...
type NetworkDeviceRoleBaseline struct {
	...
	TwoNetworkIso   string `gorm:"column: two_network_iso" json:"twoNetworkIso"`    // 两网分离
	ThreeNetworkIso string `gorm:"column:three_network_iso" json:"threeNetworkIso"` // 三网分离
	TriplePlay      string `gorm:"column:triple_play" json:"triplePlay"`            // 三网合一
